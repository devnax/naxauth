...
const emailTempalte = ({ logo, title, description, action, footer, address, color }: EmailTemplateData) => {
                        ...
                        <tr>
                           ...
                           <td class="content-cell"
                              ...
                              <div class="f-fallback">
                                 ...
                                 ${logo ? `<img src="${logo}" style="margin-bottom: 20px;" />` : ''}

                                 <h1 style="margin-top: 0; color: #333333; font-size: 22px; font-weight: bold; text-align: left;"
                                    align="left">${title}</h1>

                                 <div style="font-size: 16px; line-height: 1.625; color: #333; margin: .4em 0 1.1875em;">
                                   ${description}
                                 </div>
                                          ...
                                          <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                             ...
                                             <tr>
                                                ...
                                                <td align="center"
                                                   ...
                                                   ${action?.link ? `
                                                    <a href="${action.link}" class="f-fallback button button--green"
                                                      target="_blank"
                                                      style="color: #FFF; border-color: ${color}; border-style: solid; border-width: 10px 18px; background-color: ${color}; display: inline-block; text-decoration: none; border-radius: 3px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.16); -webkit-text-size-adjust: none; box-sizing: border-box;">
                                                        ${action.text}
                                                      </a>
                                                    ` : ''}
                                                </td>
